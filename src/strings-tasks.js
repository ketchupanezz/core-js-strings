...
function removeLastOccurrences(str, value) {
  const cleanStr = str.replace(/[^a-b0-9 ]/gi);
  return cleanStr.split('').reverse().replace(value, '');
}
